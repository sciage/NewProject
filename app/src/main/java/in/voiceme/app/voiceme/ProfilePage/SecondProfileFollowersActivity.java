...
public class SecondProfileFollowersActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_profile_followers);
        ...
        rv = (RecyclerView) findViewById(R.id.second_user_follower_recyclerview);
